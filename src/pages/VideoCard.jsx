...
function VideoCard({ card, handleDeletestatus,insideCategory }) {
  ...
  // to remove / delete using an api call
    ...
    {/* card */}
      ...
      <div>
        ...
        <Card className='shadow' draggable onDragStart={e=>dragStarted(e,card?.id)} >
          ...
          <Card.Body>
            <Card.Title><span>{card?.caption}</span>
              <span>
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            <iframe width={'100%'} height={'400px'} src={`${card?.url}?autoplay=1`} title="Leo | Official Tamil Trailer | Thalapathy Vijay,  Lokesh Kanagaraj, Trisha Krishnan" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </Modal.Body>
